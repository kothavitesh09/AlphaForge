...
class Settings(BaseSettings):
    ...
    market_data_provider: str = Field("coindcx", alias="MARKET_DATA_PROVIDER")
    koinbx_fallback_enabled: bool = Field(True, alias="KOINBX_FALLBACK_ENABLED")
    coindcx_candles_url: str = Field("https://public.coindcx.com/market_data/candles", alias="COINDCX_CANDLES_URL")
    coindcx_markets_url: str = Field("https://api.coindcx.com/exchange/v1/markets_details", alias="COINDCX_MARKETS_URL")
    coindcx_tickers_url: str = Field("https://api.coindcx.com/exchange/ticker", alias="COINDCX_TICKERS_URL")
    coindcx_order_book_url: str = Field("https://public.coindcx.com/market_data/orderbook", alias="COINDCX_ORDER_BOOK_URL")
